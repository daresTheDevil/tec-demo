<template>
  <div class="py-16 bg-gray-50 dark:bg-gray-800 overflow-hidden lg:py-24">
    <div class="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
      ...
      <div class="relative">
        <h2
          class="text-center text-3xl leading-none font-extrabold tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl"
        >
          Connect and protect your
          <span class="underline text-purple-800 dark:text-purple-500"
            >home</span
          >
          or
          <span class="underline text-orange-700 dark:text-orange-500"
            >business</span
          >
        </h2>
        <p
          class="mt-4 max-w-3xl mx-auto text-center text-xl text-gray-600 dark:text-gray-300"
        >
          Just let these leaves jump off the brush Everyone needs a friend.
          Friends are the most valuable things in the world. Didn't you know you
          had that much power? You can move mountains. You can do anything.
        </p>
      </div>
      ...
      >
        <div class="relative">
          <h3
            class="text-2xl font-extrabold text-gray-900 dark:text-gray-100 tracking-tight sm:text-3xl"
          >
            Home services
          </h3>
          <p class="mt-3 text-lg text-gray-600 dark:text-gray-300">
            Improve your life with TEC solutions for your home. Take advantage
            of high-speed Internet, voice, and state-of-the-art security
            systems.
          </p>
      ...
      <div class="relative mt-12 sm:mt-16 lg:mt-24">
        ...
        >
          <div class="lg:col-start-2">
            ...
            <p class="mt-3 text-lg text-gray-600 dark:text-gray-300">
              Solutions that suit your business. TEC offers made-to-measure
          ...
          <div class="mt-10 -mx-4 relative lg:mt-0 lg:col-start-1">
            ...
            <img
              class="relative mx-auto overflow-hidden rounded-lg shadow-lg h-96 object-cover object-center"
              width="490"
              height="400"
